...
rule eligos2_pair_diff_mod:
    ...
    output:
        res_tsv=join(
            ...
            module_name,
            rule_name,
            "test_vs_control_on_transcriptome_reference_combine.txt",
        ),
    log:
        join("logs", module_name, rule_name, "out.log"),
    threads: get_threads(config, rule_name)
    ...
    resources:
        mem_mb=get_mem(config, rule_name),
    container:
        "library://aleg/default/eligos2:2.0.0"
    script:
        "../scripts/eligos2_pair_diff_mod.py"
...
rule eligos2_postprocess:
    ...
    container:
        "library://aleg/default/metacompore_python:3.8.6"
    script:
        "../scripts/eligos2_postprocess.py"
