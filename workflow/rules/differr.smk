...
rule differr_compare:
    input:
        control_bam=expand(
            join("results", "alignment", "alignmemt_postfilter", "control_{rep}.bam"),
            rep=replicates_list,
        ),
        test_bam=expand(
            join("results", "alignment", "alignmemt_postfilter", "test_{rep}.bam"),
            rep=replicates_list,
        ),
    ...
    container:
        "library://aleg/default/differr_nanopore_drs:latest"
    script:
        "../scripts/differr_compare.py"
...
rule differr_postprocess:
    ...
    script:
        "../scripts/differr_postprocess.py"
